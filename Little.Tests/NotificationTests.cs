...
namespace Little.Tests
{
   public class NotificationTests: BaseFixture
   {
      ...
      public void SendsALikeRequest()
      {
         ...
         var notification = new Driver("yek", "secrettt").Notification("paul", 5);
      ...
      public void RespondToNotification()
      {
         ...
         new Driver("yek", "secrettt").RespondToNotification("paul", "123", 6);
      }

      [Test]
      public void RespondToNotificationSignature()
      {
         Assert.AreEqual("9695fe627633f344b6bde27cd2391e772d8026d8", new Driver("yek", "secrettt").RespondToNotificationSignature("duncan", "8458577"));
      }
   }
}